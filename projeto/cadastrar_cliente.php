    ...
    <h1>Cadastrar novo cliente</h1>
        <form id="formulario" data-bs-theme="dark" method="POST" action="">
            <div class="mb-3">
                ...
                <input value="<?php if(isset($_POST['nome'])) echo $_POST['nome']; ?>" type="text" placeholder="Nome Completo" class="form-control" id="nome" name="nome">
            </div>
            <div class="mb-3">
                <label for="email" class="form-label">Email</label>
                <input value="<?php if(isset($_POST['email'])) echo $_POST['email']; ?>" type="email" placeholder="email@provedor.com.br" class="form-control" id="email" name="email">
            </div>
            <div class="mb-3">
                <label for="telefone" class="form-label">Telefone</label>
                <input value="<?php if(isset($_POST['telefone'])) echo $_POST['telefone']; ?>" type="text" placeholder="(11) 98888-8888" class="form-control" id="telefone" name="telefone">
            </div>
            <div class="mb-3">
                <label for="nascimento" class="form-label">Data de Nascimento</label>
                <input value="<?php if(isset($_POST['nascimento'])) echo $_POST['nascimento']; ?>" type="date" class="form-control" id="nascimento" name="nascimento">
            </div>
        </form>
